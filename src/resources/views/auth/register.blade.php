        ...
        <div class="grid gap-16 grid-cols-1">
            <div class="flex flex-col">
                ...
                <div class="mt-5">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col items-center justify-center gap-4 m-4">
                            <button type='button' data-id="association" onclick='changeRole(event)' class='role transition-all border-[1px] border-[#03071E] shadow-sm rounded px-6 py-4 text-start flex items-center gap-4'>
                                <svg class="w-16" viewBox="0 0 24 24" id="company-small-24px" xmlns="http://www.w3.org/2000/svg"
                                fill="#D00000" stroke="#D00000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0">
                                </g>
                            ...
                            <button type='button' data-id="user" onclick='changeRole(event)' class='role transition-all border-[1px] border-[#03071E] shadow-sm rounded px-6 py-4 text-start flex items-center gap-4'>
                                <svg class="w-16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#D00000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <circle cx="12" cy="6" r="4" fill="#D00000"></circle> <path d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" fill="#D00000"></path> </g></svg>
                                <div>
                    ...
                    px-6 py-3 block shadow-xl bg-black"> Register Now
                    </button>
