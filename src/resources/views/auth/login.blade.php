...
<div class="relative min-h-screen flex items-center justify-center bg-center py-12 px-4 sm:px-6 lg:px-8 bg-no-repeat bg-cover relative items-center bg-[url('{{asset('image/test.jpg')}}')]">
            ...
            <div class="flex flex-col">
                ...
                <div class="mt-5">
                    <form method="POST" action="{{ route('login.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-6">
                            <label class="block mb-2 font-extrabold text-[#2D3E4E]" >Email</label>
                            <input class="inline-block w-full p-4 leading-6  bg-white shadow border border-gray-400 rounded-lg focus:border-[#E44A19] focus:outline-none " type="email" name="email" >
                          </div>
                          <div class="mb-6">
                            <label class="block mb-2 font-extrabold text-[#2D3E4E]" >Password</label>
                            <input class="inline-block w-full p-4 leading-6  bg-white shadow border border-gray-400 rounded-lg focus:border-[#E44A19] focus:outline-none " type="password" name="password">
                          </div>
                          <div class="flex flex-wrap -mx-4 mb-6 items-center justify-between">
                            <div class="w-full lg:w-auto px-4 mb-4 lg:mb-0">
                              <label for="">
                                <input type="checkbox">
                                <span class="ml-1 font-extrabold text-[#2D3E4E] ">Remember me</span>
                              </label>
                            </div>
                            <div class="w-full lg:w-auto px-4 "><a class="inline-block font-extrabold text-[#272343] " href="#">Forgot your password?</a></div>
                          </div>
                          ...
                          px-6 py-3 block shadow-xl bg-[#E44A19]">Sign in</button>
                          <p class="text-center font-extrabold text-[#272343]">Don&rsquo;t have an account? <a class="text-[#E44A19] underline" href="{{ route('register') }}">Sign up</a></p>
                    </form>
                </div>
            </div>
        </div>
