...
<section id="Projects"
    class=" w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 justify-items-center justify-center gap-24 mt-10 mb-5">

    <!--   ✅ Product card 1 - Starts Here 👇 -->
    <div class="relative w-64 bg-[#EFF0F3] shadow-md rounded-xl ">
        <a href="#">
            <img src="{{asset('image/cat7.jpg')}}"
                    alt="Product" class="h-72 w-64 object-cover rounded-t-xl" />
            <div class="px-4 py-3 w-72">
                <span class="text-[#2D3E4E] mr-3 uppercase text-md font-bold">Maison </span>
                <p class="text-lg font-bold text-[#272343] truncate block capitalize m-4">Donne lot de serviettes et gants de bain carré blanc</p>
        ...
        <div class="absolute top-0 mx-auto flex flex-col translate-x-[-125%] p-2 bg-[#094839] gap-4 justify-center rounded-xl">
                ...
                <svg class="text-white w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg" width="24"  height="24"   viewBox="0 0 20 20"
                     fill="currentColor">  <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
        ...
        <a href="#">
            ...
            <div class=" relative px-4 py-3">
                <div class="absolute w-full top-0 left-0 translate-y-[-50%] flex items-center justify-center">
                     <p class="p-2 bg-[#E44A19] text-white px-4 rounded-lg">Status</p>
                </div>
                <p class="text-[#2D3E4E] mr-3 uppercase text-md font-bold mt-8">Maison </p>
                <p class="text-lg font-bold text-[#272343] truncate block capitalize m-4">Donne lot de serviettes et gants de bain carré blanc</p>
            </div>
        </a>
        <div class="absolute top-0 mx-auto flex flex-col translate-x-[-125%] p-2 bg-[#094839] gap-4 justify-center rounded-xl">
