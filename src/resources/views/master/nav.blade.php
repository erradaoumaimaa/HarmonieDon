...
<nav
  ...
  <div class="container flex items-center justify-between mx-auto ">
    ...
    <div class="hidden lg:block">
      ...
      <li class="flex items-center p-1 text-sm antialiased font-semibold leading-normal gap-x-2 {{ request()->routeIs('donors.index') ? 'text-[#E44A19]' : 'text-white' }} cursor-pointer active">
  <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"/>
  </svg>
  <a href="{{ route('donors.index') }}" class="flex items-center {{ request()->routeIs('donors.index') ? 'text-[#E44A19]' : 'text-white' }}">
    Home
  </a>
</li>
         ...
         <li class="text-[#8095A8]">
                ...
                xmlns="http://www.w3.org/2000/svg" width="24" height="24"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"/>
                   ...
                   <!--Create donation-->
                   <li class="flex items-center p-1 text-sm antialiased font-semibold leading-normal gap-x-2 {{ request()->routeIs('donors.create') ? 'text-[#E44A19]' : 'text-white' }} cursor-pointer active">
                    <svg class="w-5 h-5 {{ request()->routeIs('donors.create') ? 'text-[#E44A19]' : 'text-white' }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"/>
                    </svg>
                    <a href="{{ route('donors.create') }}" class="flex items-center {{ request()->routeIs('donors.create') ? 'text-[#E44A19]' : 'text-white' }}">
                        Add Donation
                    </a>
                    </li>
...
<li class="flex items-center p-1 text-sm antialiased font-semibold leading-normal gap-x-2 {{ request()->routeIs('users.index') ? 'text-[#E44A19]' : 'text-white' }} cursor-pointer active">
  <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"/>
  </svg>
  <a href="{{ route('users.index') }}" class="flex items-center {{ request()->routeIs('users.index') ? 'text-[#E44A19]' : 'text-white' }}">
    Home
  </a>
</li>
         ...
         <li class="text-[#8095A8]">
                ...
                xmlns="http://www.w3.org/2000/svg" width="24" height="24"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"/>
                   ...
                   <!--Explore-->
                   <li class="flex items-center p-1 text-sm antialiased font-semibold leading-normal gap-x-2 {{ request()->routeIs('users.explore') ? 'text-[#E44A19]' : 'text-white' }} cursor-pointer active">
    <svg class="w-6 h-6 {{ request()->routeIs('users.explore') ? 'text-[#E44A19]' : 'text-white' }}"
        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="12" cy="12" r="10" />
        <polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76" />
    </svg>
    <a href="{{ route('users.explore') }}" class="flex items-center {{ request()->routeIs('users.explore') ? 'text-[#E44A19]' : 'text-white' }}">
        Explore
    </a>
</li>
...
@endauth
  ...
  <a href="{{ auth()->user()->role == 'association' ? route('association.profile') : (auth()->user()->role == 'donor' ? route('donors.profile') : (auth()->user()->role == 'user' ? route('users.profile') : (auth()->user()->role == 'admin' ? route('admin.profile') : ''))) }}" class="flex items-center {{ request()->routeIs('donors.profile') ? 'text-[#E44A19]' : 'text-white' }}">
    Profile
  </a>
</li>
