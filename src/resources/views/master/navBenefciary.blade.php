  ...
  <a href="{{ route('donors.index') }}" class="flex items-center {{ request()->routeIs('donors.index') ? 'text-[#E44A19]' : 'text-white' }}">
    Home
         ...
         <li class="text-[#8095A8]">
                ...
                xmlns="http://www.w3.org/2000/svg" width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round" class="{{ request()->routeIs('donors.donations') ? 'text-[#E44A19]' : 'text-white' }}">
